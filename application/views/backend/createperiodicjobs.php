...
<h4 class="pad-left-15 capitalize">Periodic Jobs</h4>
  ...
  <div class="pad-left-15">
    <div class="col s12 m12">
      <div class="right">
        <button class="waves-effect waves-light btn deep-orange lighten-3 " style="color:black;" onclick="changestatus(this.id)" id="1" >Pending</button>
